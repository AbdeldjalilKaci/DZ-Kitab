...
class Rating(Base):
    ...
    buyer = relationship("User", foreign_keys=[buyer_id], back_populates="ratings_given", lazy="select")
    seller = relationship("User", foreign_keys=[seller_id], back_populates="ratings_received", lazy="select")
    announcement = relationship("Announcement", back_populates="ratings", lazy="select")
...
class SellerStats(Base):
    ...
    user = relationship("User", back_populates="seller_stats", lazy="select")
